...
const Intro = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          <motion.span
            ...
            className="absolute text-2xl bottom-0 right-1"
          >
            🤖
          </motion.span>
        </div>
      ...
      >
        <b className="font-bold">Hi, I&apos;m {OWNER_NAME}.</b>{" "}
        I&apos;m a <b className="font-bold">full-stack developer</b> with{" "}
        <b className="font-bold">2 years</b> of parctical experience in JavaScript and framework like ReactJS. 
        I enjoy building{" "}
        <i className="italic">sites and apps</i>. My focus is{" "}
        <u className="underline">MERN Stack with python(FastAPI)</u>.
      </motion.h1>
