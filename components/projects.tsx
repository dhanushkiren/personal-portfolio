...
const Projects = () => {
  ...
  return (
    <section ref={ref} id="projects" className="scroll-mt-28 mb-28">
      ...
      <div className="font-medium font-bold text-center mb-2">* THE BELOW PROJECTS ARE NOT DEPLOYED *</div>
      <div className="font-small text-center mb-4">- They will navigate to the GitHub page -</div>
      <div>
